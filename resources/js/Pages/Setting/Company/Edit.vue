...
const { props } = usePage();
const { title, desc, company } = props;
...
function handleSubmit() {
    ...
    router.put(route('companies.update', company.slug), form, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            toast.success('Data Perusahaan berhasil diubah!');
            form.reset();
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="handleSubmit">
                            ...
                            <div class="flex items-center justify-end mt-4 space-x-2">
                                <SubmitButton :processing="isProcessing" :disabled="!form.isDirty" @click="handleSubmit" label="Update" />

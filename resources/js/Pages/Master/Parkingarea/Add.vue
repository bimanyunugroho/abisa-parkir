...
function handleSubmit() {
    ...
    router.post(route('parking_areas.store'), form, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            toast.success('Master area parkir berhasil disimpan!');
            form.reset();
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="handleSubmit">
                            <div class="mb-4">
                                ...
                                <TextInputUppercase id="name" v-model="form.name" type="text" class="mt-1 block w-full" required autofocus />
                            ...
                            <div class="mb-4">
                                ...
                                <TextNumeric id="capacity" v-model="form.capacity" class="mt-1 block w-full" placeholder="Enter capacity" :min="0" />

...
const { props } = usePage();
const { title, desc, permission, errors: pageErrors } = props;
...
function handleSubmit() {
    ...
    router.put(route('permissions.update', permission.slug), form, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            toast.success('Data Permission berhasil diubah!');

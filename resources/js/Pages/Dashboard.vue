...
const { props } = usePage();
const { title, desc, parkingData } = props;
...
onMounted(() => {
    ...
    new Chart(revenueCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Pendapatan',
                data: [parkingData.revenue.yesterday, parkingData.revenue.today],
        ...
        <div class="py-12 bg-gray-100 dark:bg-gray-900">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <!-- Occupancy Chart -->
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg transition duration-300 ease-in-out hover:shadow-xl">
                        <div class="p-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg transition duration-300 ease-in-out hover:shadow-xl">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Total Spot Parkir</h3>
                            <p class="text-4xl font-bold text-indigo-600 dark:text-indigo-400">{{ parkingData.totalSpots }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg transition duration-300 ease-in-out hover:shadow-xl">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Durasi Rata-rata Parkir</h3>
                            <p class="text-4xl font-bold text-orange-600 dark:text-orange-400">{{ parkingData.averageDuration }} menit</p>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg transition duration-300 ease-in-out hover:shadow-xl">
                        <div class="p-6">
                            ...
                            <p class="text-4xl font-bold text-purple-600 dark:text-purple-400">{{ parkingData.peakHour }}</p>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg transition duration-300 ease-in-out hover:shadow-xl">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Pelanggan Bulanan</h3>
                            <p class="text-4xl font-bold text-teal-600 dark:text-teal-400">{{ parkingData.monthlySubscribers }}</p>
